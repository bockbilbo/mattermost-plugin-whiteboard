...
var uidchars = []rune("abcdefghijklmnopqrstuvwxyzABCDFGHIJKLMNOPQRSTUVWXYZ0123456789")
...
func generateExcalidrawID() string {
	return randomString(hexdigits, 20) + "," + randomString(uidchars, 22)
}
